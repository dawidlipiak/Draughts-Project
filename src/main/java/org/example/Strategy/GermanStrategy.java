 ...
 * Class with applied moves roles from German version of the game.
 * In this version: normal pawn can beat back, King can move multiple fields,
 * normal pawn can beat up a king.
 */
public class GermanStrategy implements MovesStrategy {
     ...
     */
    public GermanStrategy(int nrOfFields) {
    ...
    public void addlegalJumps(final ArrayList<Movement> moves, final int distance, final Pawn[][] pawnsBoard, final Player player, final int row, final int col) {
        ...
        GermanStrategy.Function function = new GermanStrategy.Function() {
            @Override
